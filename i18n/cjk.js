...
(function (root) {
  ...
  var COPY = {
    ja: {
      ...
      keepQ: "キープとは？",
      keepA: "有料ダウンロードは店の価格。キープは30日無料のあと月額（Apple表示）。アリソン：記録はキープなしでも読める。新しい開始・食事・ヘルス取得はキープ待ち。パックラン：公園一覧は残る。チェックインはキープ待ち。試用またはキープが終わるとそれらの機能も終わる。キープ画面で復元。解約はAppleのサブスクリプション。",
      reach: "連絡先は？",
    ...
    "zh-Hans": {
      ...
      keepQ: "续订是什么？",
      keepA: "付费下载按商店标价。续订是 30 天免费，随后按月（Apple 显示价）。Alison：没有续订也能读记录；新的开始、饮食和健康拉取要等续订。遛狗：公园列表还在；签到要等续订。试用或续订结束后，这些功能结束。在续订页恢复。在 Apple 订阅里取消。",
      reach: "怎么联系？",
      mail: "support@nightorders.app",
    ...
    "zh-Hant": {
      ...
      keepQ: "續訂是什麼？",
      keepA: "付費下載按商店標價。續訂是 30 天免費，隨後按月（Apple 顯示價）。Alison：沒有續訂也能讀紀錄；新的開始、飲食和健康拉取要等續訂。遛狗：公園列表還在；簽到要等續訂。試用或續訂結束後，這些功能結束。在續訂頁回復。在 Apple 訂閱裡取消。",
      reach: "怎麼聯絡？",
      mail: "support@nightorders.app",
    ...
    ko: {
      ...
      keepQ: "킵이 뭐죠?",
      keepA: "유료 다운로드는 스토어 가격. 킵은 30일 무료 후 월간(Apple 표시). Alison: 킵 없이도 기록을 읽을 수 있음. 새 시작, 식사, 건강 가져오기는 킵 대기. 팩런: 공원 목록은 남음. 체크인은 킵 대기. 체험 또는 킵이 끝나면 그 기능도 끝. 킵 화면에서 복원. Apple 구독에서 해지.",
      reach: "연락은?",
      mail: "support@nightorders.app",
    ...
    th: {
      ...
      keepQ: "คีปคืออะไร",
      keepA: "ดาวน์โหลดเสียเงินตามราคาในร้าน คีปทดลอง 30 วัน แล้วรายเดือน (ราคา Apple) Alison อ่านบันทึกได้โดยไม่ต้องคีป เริ่ม มื้ออาหาร และดึงสุขภาพใหม่รอคีป แพ็กรัน รายการสวนยังอยู่ เช็คอินรอคีป เมื่อทดลองหรือคีปจบ ฟีเจอร์เหล่านั้นจบ กู้ในหน้าคีป ยกเลิกใน Apple Subscriptions",
      reach: "ติดต่ออย่างไร",
      mail: "support@nightorders.app",
    ...
    vi: {
      ...
      keepQ: "Keep là gì?",
      keepA: "Tải trả phí theo giá cửa hàng. Keep dùng thử 30 ngày rồi hàng tháng (giá Apple). Alison: nhật ký vẫn đọc được không cần Keep; Bắt đầu, Ăn, và kéo Sức khỏe mới chờ Keep. Đàn chạy: danh sách công viên còn; vào chờ Keep. Hết thử hoặc Keep thì những dịch vụ đó hết. Khôi phục trên màn Keep. Hủy trong Apple Subscriptions.",
