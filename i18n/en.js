...
(function (root) {
  ...
  var enUS = {
    ...
    alisonStart: "Start",
    alisonStop: "Stop",
    alisonStarted: "Started",
    alisonStopped: "Stopped",
    alisonLive: "On",
    alisonDelete: "Delete",
    alisonAdd: "Add",
    ...
    alisonFoodHelp: "A day first. Breakfast, lunch, dinner, snacks. Type what you ate. Ingredients still matter.",
    alisonFoodDay: "Day",
    alisonFoodDayHintToday: "Today. Tap for another day.",
    alisonFoodDayHintOther: "Tap for another day.",
    alisonFoodNoCals: "No calories on this day yet. Typed foods keep name and amount only.",
    alisonFoodSlotEmpty: "Nothing here yet.",
    alisonFoodBreakfast: "Breakfast",
    alisonFoodLunch: "Lunch",
    alisonFoodDinner: "Dinner",
    alisonFoodSnacks: "Snacks",
    alisonAddFood: "Add Food",
    alisonFoodAmountHint: "Saves as 1 Serving. No invented calories on a typed food.",
    alisonFoodCalPrev: "Prev",
    alisonFoodCalNext: "Next",
    alisonFoodYesterday: "Yesterday",
    alisonFoodToday: "Today",
    alisonFoodCalClose: "Close calendar",
    ...
    alisonClinicOpen: "The count is honest. Still not a diagnosis. Not a medical device.",
    alisonShareMonth: "Share month",
    alisonShareCopied: "Copied. Take this to a clinician. Not a diagnosis.",
